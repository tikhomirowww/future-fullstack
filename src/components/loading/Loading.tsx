    ...
    >
      ...
      <div className={styles.hamster}>
        <div className={styles.hamster__body}>
          ...
          <div
            className={styles.hamster__limb + " " + styles.hamster__limb__fr}
          ></div>
          <div
            className={styles.hamster__limb + " " + styles.hamster__limb__fl}
          ></div>
          <div
            className={styles.hamster__limb + " " + styles.hamster__limb__br}
          ></div>
          <div
            className={styles.hamster__limb + " " + styles.hamster__limb__bl}
          ></div>
